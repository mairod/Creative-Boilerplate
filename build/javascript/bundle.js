...
var _myComponentClass = __webpack_require__(4);

var _myComponentClass2 = _interopRequireDefault(_myComponentClass);

var _toolsClass = __webpack_require__(5);

var TOOLS = _interopRequireWildcard(_toolsClass);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var test = new _myComponentClass2.default();
...
var FrameRateUI = exports.FrameRateUI = function () {
    function FrameRateUI(options) {
        _classCallCheck(this, FrameRateUI);
    ...
    _createClass(FrameRateUI, [{
        ...
        key: 'raw_to_displayed',
        value: function raw_to_displayed() {
        ...
        key: 'draw_stats',
        value: function draw_stats(index, ratio, fps) {
            var ctx = this.context;
        ...
        key: 'color_selector',
        value: function color_selector(fps) {
            if (fps < 20) {
                return '#E86252';
            } else if (fps < 30) {
                return '#DBD56E';
...
var AudioAnalyzer = exports.AudioAnalyzer = function () {
    ...
    _createClass(AudioAnalyzer, [{
        ...
        key: 'addControlPoint',
        value: function addControlPoint(options) {
        ...
        value: function updateControlPoint() {
            var ctx = this.context;
